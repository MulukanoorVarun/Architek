...
import 'package:tripfin/Bloc/Logic/Home/HomeState.dart';
              ...
              body: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                      ...
                      Dismissible(
                        ...
                        confirmDismiss: (direction) async {
                          ...
                          if (direction == DismissDirection.startToEnd) {
                            context.push('/UpdateCurrentTrip?tripId=$tripId');
                            return false;
                            ...
                            if (confirm == true) {
                              try {
                                await context.read<postTripCubit>().deleteTrip(
                                  tripId,
                                );
                                await context.read<HomeCubit>().fetchHomeData();
                                return true;
                    ...
                    Column(
                      children: [
                        if (state.getPrevousTripModel?.previousTrips?.isEmpty ??
                            true)
                          Container(
                            width: double.infinity,
                            padding: EdgeInsets.all(width * 0.04),
